  ...
  return (
    <div className="bg-primary min-h-screen flex items-center justify-center py-5">
      <div className="mt-20 lg:w-full  lg:max-w-4xl  bg-white rounded-xl shadow-sm p-20">
        ...
        <button className="text-md text-gray-100 mx-auto m-5 px-24 pb-3 rounded-lg bg-brown flex items-center justify-center hover:bg-red-500 hover:text-gray-900"> Order now</button>
      </div>
